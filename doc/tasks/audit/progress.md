...
- 已新增统一审计桥接 adapter，覆盖 identity-access、tenant-project、source-repository、application-workload、build、release-delivery、gitops-deployment 和 cluster-agent 的 AuditLogger 接口。
