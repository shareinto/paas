...
- 已实现 MySQL 正式表仓储、部署模板版本、应用模板从平台基础模板复制、模板校验、values.yaml 更新、dev/test 直接 commit、staging/prod 创建 MR、ManifestRevision 记录、Deployment 查询、Agent 状态映射和回滚 digest 场景测试。
